...
This document provides file-level implementation instructions for connecting the existing Rust backend with the React frontend dashboard. It references `../admin-api/01-api-spec.md` for the API contract.

**Prerequisite**: Read `../admin-api/01-api-spec.md` for the complete API and WebSocket specification.
